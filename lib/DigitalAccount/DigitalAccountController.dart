...
import 'DigitalAccountModel.dart';

class DigitalAccountController extends GetxController {
  bool haveAccount = false;
  bool Confirm = false;
  DigitalAccountModel digitalAccountModel;
  DigitalAccountModel digitalAModel;
  ErrorRe _errorRe;
  ...
  Future getDigitalAccount() async {
    print("api get my DA called");
    final url = Global.url + 'api/AccountCreation/GetCustomerDegitalAccount';
      ...
      if (response.statusCode == 200) {
        ...
        _errorRe.hasErrors == true
            ...
            : {
                haveAccount = true,
                digitalAccountModel =
                    digitalAccountModelFromJson(response.body),
                Confirm = digitalAccountModel.result.confirmed,
                //   return _digitalAccountModel;
              };
        update();
      } else {
        Get.back();
